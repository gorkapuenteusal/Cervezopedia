...
final class ManufacturerManagerTests: XCTestCase {
    ...
    lazy var manufacturer = ManufacturerModel(name: "A manufacturer", location: "US", logoName: "")!
    lazy var sameManufacturer = ManufacturerModel(name: "A manufacturer", location: "US", logoName: "")!
    lazy var differentManufacturer = ManufacturerModel(name: "Another manufacturer", location: "ES", logoName: "")!
    lazy var sameDifferentManufacturer = ManufacturerModel(name: "Another manufacturer", location: "ES", logoName: "")!
